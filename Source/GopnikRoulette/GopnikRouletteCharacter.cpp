...
#include "GopnikRouletteCharacter.h"
#include "GopnikRouletteProjectile.h"
...
//////////////////////////////////////////////////////////////////////////
// AGopnikRouletteCharacter

AGopnikRouletteCharacter::AGopnikRouletteCharacter()
{
...
void AGopnikRouletteCharacter::Tick(float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);
}

void AGopnikRouletteCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AGopnikRouletteCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveRight", this, &AGopnikRouletteCharacter::MoveRight);
...
void AGopnikRouletteCharacter::OnFire()
{
	...
	if (ProjectileClass)
	{
		...
		if (World != nullptr)
		{
			...
			World->SpawnActor<AGopnikRouletteProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
		}
	}
...
void AGopnikRouletteCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AGopnikRouletteCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AGopnikRouletteCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
