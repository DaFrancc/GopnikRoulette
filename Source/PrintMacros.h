...
#define PRINTL1(Text) UE_LOG(LogTemp, Warning, Text)
#define PRINTL2(Text, Verbosity) UE_LOG(LogTemp, Verbosity, Text)
#define PRINTL3(Text, Verbosity, Category) UE_LOG(Category, Verbosity, Text)
